...
npx nx g @nx/react:lib [name] --publishable --bundler=rollup --imporPath=[name] --directory packages/[name]
--compiler=swc --testEnvironment=jsdom --unitTestRunner=jest

npx nx g @nx/js:lib [name] --publishable --bundler=rollup --importPath=[name] --directory packages/[name]
--testEnvironment=jsdom --unitTestRunner=jest
