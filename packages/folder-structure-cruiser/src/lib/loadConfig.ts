...
// `validate-cross-feature-imports`, `validate-no-orphans` and
// `validate-shared-components` add no options of their own beyond the shared
// command section, so they reuse it directly.
