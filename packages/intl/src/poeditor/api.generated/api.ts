...
export type ProjectListProjectsInnerPublicEnum =
  (typeof ProjectListProjectsInnerPublicEnum)[keyof typeof ProjectListProjectsInnerPublicEnum]
export const ProjectListProjectsInnerOpenEnum = {
  NUMBER_0: 0,
  NUMBER_1: 1,
} as const

export type ProjectListProjectsInnerOpenEnum =
  (typeof ProjectListProjectsInnerOpenEnum)[keyof typeof ProjectListProjectsInnerOpenEnum]
...
export type ProjectLongProjectPublicEnum =
  (typeof ProjectLongProjectPublicEnum)[keyof typeof ProjectLongProjectPublicEnum]
...
export const ContributorsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    contributorsAdd: async (
      id: string,
      name: string,
      email: string,
      apiToken?: string,
      language?: string,
      admin?: ContributorsAddAdminEnum,
...
export const ContributorsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async contributorsAdd(
      ...
      admin?: ContributorsAddAdminEnum,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Response>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.contributorsAdd(
        id,
        name,
        email,
        apiToken,
      ...
      const localVarOperationServerBasePath =
        operationServerMap["ContributorsApi.contributorsAdd"]?.[localVarOperationServerIndex]?.url
    ...
    async contributorsRemove(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.contributorsRemove(
        id,
        email,
        apiToken,
        language,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ContributorsApi.contributorsRemove"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async translationsList(
      ...
      language?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContributorsListResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.translationsList(apiToken, id, language, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ContributorsApi.translationsList"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const ContributorsApiFactory = function (
  ...
  return {
    ...
    translationsList(
      ...
      language?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ContributorsListResponse> {
...
export class ContributorsApi extends BaseAPI {
  ...
  public contributorsAdd(
    ...
    return ContributorsApiFp(this.configuration)
      .contributorsAdd(id, name, email, apiToken, language, admin, options)
...
export const LanguagesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    languagesUpdate: async (
      id: number,
      language: string,
      data: string,
      apiToken?: string,
      fuzzyTrigger?: LanguagesUpdateFuzzyTriggerEnum,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
...
export const LanguagesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async languagesAdd(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["LanguagesApi.languagesAdd"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async languagesDelete(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["LanguagesApi.languagesDelete"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async languagesList(
      ...
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LanguagesListLongResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.languagesList(id, apiToken, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["LanguagesApi.languagesList"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async languagesUpdate(
      ...
      fuzzyTrigger?: LanguagesUpdateFuzzyTriggerEnum,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TranslationsShortResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.languagesUpdate(
        id,
        language,
        data,
        apiToken,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["LanguagesApi.languagesUpdate"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async projectsAvailable(
      id: number,
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LanguagesListShortResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.projectsAvailable(id, apiToken, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["LanguagesApi.projectsAvailable"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const LanguagesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    languagesList(
      ...
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<LanguagesListLongResponse> {
    ...
    languagesUpdate(
      ...
      fuzzyTrigger?: LanguagesUpdateFuzzyTriggerEnum,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<TranslationsShortResponse> {
      return localVarFp
    ...
    projectsAvailable(
      ...
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<LanguagesListShortResponse> {
...
export type LanguagesUpdateFuzzyTriggerEnum =
  (typeof LanguagesUpdateFuzzyTriggerEnum)[keyof typeof LanguagesUpdateFuzzyTriggerEnum]
...
export const ProjectsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    projectsExport: async (
      id: number,
      language: string,
      type: ProjectsExportTypeEnum,
      apiToken?: string,
      filters?: string,
      order?: string,
      tags?: string,
      _options?: ProjectsExportOptionsEnum,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
    ...
    projectsUpload: async (
      updating: ProjectsUploadUpdatingEnum,
      file: File,
      apiToken?: string,
      id?: number,
      language?: string,
      overwrite?: ProjectsUploadOverwriteEnum,
      syncTerms?: ProjectsUploadSyncTermsEnum,
      tags?: string,
      readFromSource?: ProjectsUploadReadFromSourceEnum,
      fuzzyTrigger?: ProjectsUploadFuzzyTriggerEnum,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
...
export const ProjectsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async projectsAdd(
      ...
      description?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectViewResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.projectsAdd(name, apiToken, description, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ProjectsApi.projectsAdd"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async projectsDelete(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ProjectsApi.projectsDelete"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async projectsExport(
      ...
      _options?: ProjectsExportOptionsEnum,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectExportResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.projectsExport(
        id,
        language,
        type,
        apiToken,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ProjectsApi.projectsExport"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async projectsList(
      apiToken: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectListResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.projectsList(apiToken, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ProjectsApi.projectsList"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async projectsSync(
      ...
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectSyncResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.projectsSync(id, data, apiToken, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ProjectsApi.projectsSync"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async projectsUpdate(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ProjectsApi.projectsUpdate"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async projectsUpload(
      ...
      fuzzyTrigger?: ProjectsUploadFuzzyTriggerEnum,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectUploadResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.projectsUpload(
        updating,
        file,
        apiToken,
        id,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ProjectsApi.projectsUpload"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async projectsView(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["ProjectsApi.projectsView"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const ProjectsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    projectsAdd(
      ...
      description?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ProjectViewResponse> {
    ...
    projectsExport(
      ...
      _options?: ProjectsExportOptionsEnum,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ProjectExportResponse> {
      return localVarFp
    ...
    projectsSync(
      ...
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ProjectSyncResponse> {
    ...
    projectsUpload(
      ...
      fuzzyTrigger?: ProjectsUploadFuzzyTriggerEnum,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ProjectUploadResponse> {
      return localVarFp
        .projectsUpload(
          updating,
          file,
 ...
 * @export
 */
export const ProjectsExportOptionsEnum = {
...
export type ProjectsUploadReadFromSourceEnum =
  (typeof ProjectsUploadReadFromSourceEnum)[keyof typeof ProjectsUploadReadFromSourceEnum]
/**
 * @export
 */
...
export type ProjectsUploadFuzzyTriggerEnum =
  (typeof ProjectsUploadFuzzyTriggerEnum)[keyof typeof ProjectsUploadFuzzyTriggerEnum]
...
export const TermsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    termsUpdate: async (
      ...
      data: string,
      apiToken?: string,
      fuzzyTrigger?: TermsUpdateFuzzyTriggerEnum,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
...
export const TermsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async termsAdd(
      ...
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TermAddedResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.termsAdd(id, data, apiToken, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["TermsApi.termsAdd"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async termsAddComment(
      id: number,
      data: string,
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TermAddCommentResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.termsAddComment(id, data, apiToken, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["TermsApi.termsAddComment"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async termsDelete(
      ...
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TermDeletedResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.termsDelete(id, data, apiToken, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["TermsApi.termsDelete"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async termsList(
      ...
      language?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TermsListFullResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.termsList(id, apiToken, language, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["TermsApi.termsList"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async termsUpdate(
      ...
      fuzzyTrigger?: TermsUpdateFuzzyTriggerEnum,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TermUpdatedResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.termsUpdate(id, data, apiToken, fuzzyTrigger, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["TermsApi.termsUpdate"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const TermsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    termsAdd(
      ...
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<TermAddedResponse> {
    ...
    termsAddComment(
      ...
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<TermAddCommentResponse> {
    ...
    termsDelete(
      ...
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<TermDeletedResponse> {
    ...
    termsList(
      ...
      language?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<TermsListFullResponse> {
    ...
    termsUpdate(
      ...
      fuzzyTrigger?: TermsUpdateFuzzyTriggerEnum,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<TermUpdatedResponse> {
...
export const TranslationsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    translationsAutomatic: async (
      id: number,
      provider: TranslationsAutomaticProviderEnum,
      apiToken?: string,
      sourceLanguage?: string,
      providerSourceLanguage?: string,
...
export const TranslationsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async translationsAdd(
      id: number,
      language: string,
      data: string,
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TranslationAddedResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.translationsAdd(id, language, data, apiToken, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["TranslationsApi.translationsAdd"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async translationsAutomatic(
      ...
      _options?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TranslationAutomatedResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.translationsAutomatic(
        id,
        provider,
        apiToken,
        sourceLanguage,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["TranslationsApi.translationsAutomatic"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async translationsDelete(
      id: number,
      language: string,
      data: string,
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TranslationDeletedResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.translationsDelete(
        id,
        language,
        data,
        apiToken,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["TranslationsApi.translationsDelete"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async translationsUpdate(
      id: number,
      language: string,
      data: string,
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TranslationUpdatedResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.translationsUpdate(
        id,
        language,
        data,
        apiToken,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap["TranslationsApi.translationsUpdate"]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const TranslationsApiFactory = function (
  ...
  return {
    ...
    translationsAdd(
      ...
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<TranslationAddedResponse> {
    ...
    translationsAutomatic(
      ...
      _options?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<TranslationAutomatedResponse> {
      return localVarFp
        .translationsAutomatic(
          id,
          provider,
    ...
    translationsDelete(
      ...
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<TranslationDeletedResponse> {
      return localVarFp
    ...
    translationsUpdate(
      ...
      apiToken?: string,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<TranslationUpdatedResponse> {
      return localVarFp
...
export type TranslationsAutomaticProviderEnum =
  (typeof TranslationsAutomaticProviderEnum)[keyof typeof TranslationsAutomaticProviderEnum]
