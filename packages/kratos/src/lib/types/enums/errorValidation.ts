...
export enum ErrorValidation {
    ...
    ErrorValidationDuplicateCredentialsWithHints = 4000028,
    ErrorValidationConst = 4000029,
    ErrorValidationConstGeneric = 4000030,
    ErrorValidationPasswordIdentifierTooSimilar = 4000031,
    ErrorValidationPasswordMinLength = 4000032,
    ErrorValidationPasswordMaxLength = 4000033,
    ErrorValidationPasswordTooManyBreaches = 4000034,
    ErrorValidationNoCodeUser = 4000035,
    ErrorValidationTraitsMismatch = 4000036,
    ErrorValidationAccountNotFound = 4000037,
    ErrorValidationCaptchaError = 4000038,
}
