...
import {
    CreateFedcmFlowResponseFromJSON,
    CreateFedcmFlowResponseToJSON,
    ...
    UpdateFedcmFlowBodyFromJSON,
    UpdateFedcmFlowBodyToJSON,
 ...
 * 
 */
export class FrontendApi extends runtime.BaseAPI implements FrontendApiInterface {
     ...
     * Get FedCM Parameters
     */
    async createFedcmFlowRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateFedcmFlowResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CreateFedcmFlowResponseFromJSON(jsonValue));
    }
     ...
     * Get FedCM Parameters
     */
    async createFedcmFlow(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateFedcmFlowResponse> {
        const response = await this.createFedcmFlowRaw(initOverrides);
        return await response.value();
    }
     ...
     * Create Verification Flow for Native Apps
     */
    async createNativeVerificationFlowRaw(requestParameters: CreateNativeVerificationFlowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VerificationFlow>> {
        const queryParameters: any = {};
     ...
     * Create Verification Flow for Native Apps
     */
    async createNativeVerificationFlow(requestParameters: CreateNativeVerificationFlowRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VerificationFlow> {
        const response = await this.createNativeVerificationFlowRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Submit a FedCM token
     */
    async updateFedcmFlowRaw(requestParameters: UpdateFedcmFlowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SuccessfulNativeLogin>> {
        if (requestParameters['updateFedcmFlowBody'] == null) {
            throw new runtime.RequiredError(
                'updateFedcmFlowBody',
                'Required parameter "updateFedcmFlowBody" was null or undefined when calling updateFedcmFlow().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UpdateFedcmFlowBodyToJSON(requestParameters['updateFedcmFlowBody']),
        }, initOverrides);
     ...
     * Submit a FedCM token
     */
    async updateFedcmFlow(requestParameters: UpdateFedcmFlowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SuccessfulNativeLogin> {
        const response = await this.updateFedcmFlowRaw(requestParameters, initOverrides);
        return await response.value();
    }
