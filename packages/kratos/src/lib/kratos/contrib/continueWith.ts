 ...
 * @param continueWith - The continue with action.
 */
export function isRedirectBrowserTo(continueWith: ContinueWith): continueWith is ContinueWithRedirectBrowserTo & {
 ...
 * @param continueWith - The continue with action.
 */
export function isShowRecoveryUi(continueWith: ContinueWith): continueWith is ContinueWithRecoveryUi & {
 ...
 * @param continueWith - The continue with action.
 */
export function isShowSettingsUi(continueWith: ContinueWith): continueWith is ContinueWithSettingsUi & {
 ...
 * @param continueWith - The continue with action.
 */
export function isShowVerificationUi(continueWith: ContinueWith): continueWith is ContinueWithVerificationUi & {
